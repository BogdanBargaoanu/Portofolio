...
const WORDS = ["Automation and Applied Informatics Student", "2+ years of Software Development", "Continuous Learning Enjoyer", "Tech Enthusiast"];
const TECH_STACK = ["C#", ".NET", "React", "SQL", "Vue", "Express", "Node"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/BogdanBargaoanu" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/bogdan-bargaoanu-598478211/" },
  { icon: Instagram, link: "https://www.instagram.com/bogdanbargaoanu" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  I'm a passionate C# and JavaScript developer with experience in building robust, scalable, and efficient solutions.
                </p>
